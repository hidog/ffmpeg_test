...
static int realloc_texture(int new_width, int new_height, int init_texture)
{
#if 0
    Uint32 format;
    int access, w, h;
...
static void calculate_display_rect(int scr_xleft, int scr_ytop, int scr_width, int scr_height,
...
static void get_sdl_pix_fmt_and_blendmode(int format, uint32_t *sdl_pix_fmt )
{
#if 0
    int i;
...
static void set_default_window_size(int width, int height, AVRational sar)
{
    ...
    calculate_display_rect( 0, 0, max_width, max_height, width, height, sar);
...
static int read_thread(void *arg)
{
    ...
    if (!audio_disable)
        st_index[AVMEDIA_TYPE_AUDIO] = av_find_best_stream(ic, AVMEDIA_TYPE_AUDIO, st_index[AVMEDIA_TYPE_AUDIO], st_index[AVMEDIA_TYPE_VIDEO],
                                NULL, 0);
