...
void    maker_encode_example()
{
    ...
    v_setting.load_jpg_root_path    =   "I:\\output\\png";
    ...
    */
    ...
    a_setting.load_pcm_path     =   "I:\\output\\test.pcm";
    ...
    a_setting.sample_fmt        =   static_cast<int>(AV_SAMPLE_FMT_FLT);
